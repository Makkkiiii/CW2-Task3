...
openssl pkeyutl -encrypt -inkey makiikey.pub -pubin -in dailyfile.txt -out dailyfile.txt.enc
...
openssl dgst -sha256 -sign denishkey.pem -out dailyfile.sig dailyfile.txt
...
scp dailyfile.txt.enc dailyfile.sig makii@192.168.56.103:~/Desktop/system2/
